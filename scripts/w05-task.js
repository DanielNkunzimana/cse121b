...
const displayTemples = (temples) => {
  templesElement.innerHTML = ''; // Clear existing temple display
  ...
  temples.forEach((temple) => {
    ...
    h3.textContent = temple.templeName; // Set temple name to h3 element
    img.src = temple.imageUrl; // Set temple image URL to img element src attribute
